...
![Stop Startup](./images/local-llm-rag/Startup.png)
...
![Edit Environment](./images/local-llm-rag/Environment.png)
...
![Ollama Host](./images/local-llm-rag/Host.png)

设置好的用户变量如下。

![User](./images/local-llm-rag/User.png)
...
![Check](./images/local-llm-rag/Check.png)
...
![Docker](./images/local-llm-rag/Docker.png)
...
![MaxKB](./images/local-llm-rag/MaxKB.png)

在选择供应商界面，我们选择「Ollama」。

![Choose](./images/local-llm-rag/Choose.png)
