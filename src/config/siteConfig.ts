...
export const siteConfig: SiteConfig = {
	...
	themeColor: {
		hue: 255, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345。默认值为165
	...
	// 站点开始日期，用于统计运行天数
	siteStartDate: "2022-09-01", // 请修改为你的站点实际开始日期，格式：YYYY-MM-DD
	...
	pages: {
		onlyabout: true, // 是否设置 关于 多级菜单 (ture为没有多级菜单，false为打开多级菜单)
		links: false, // 链接菜单开关
